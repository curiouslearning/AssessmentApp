...
public class AndroidCompiler : EditorWindow
{
    // Created window
    private static AndroidCompiler _window;
    ...
    [MenuItem("Window/Android Compiler")]
    static void Init()
    {
        if (_window == null)
        {
            _window = EditorWindow.GetWindow<AndroidCompiler>(true, "Android Compiler Utility");
            _window.Show();
        }
    }
