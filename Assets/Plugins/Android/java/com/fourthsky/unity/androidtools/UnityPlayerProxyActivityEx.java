...
public class UnityPlayerProxyActivityEx extends Activity
{
	protected void onCreate (Bundle savedInstanceState)
	{
		...
		String classNames[] = { "com.fourthsky.unity.androidtools.UnityPlayerActivityEx", "com.fourthsky.unity.androidtools.UnityPlayerNativeActivityEx" };
		...
		try
		{
			boolean supportsNative = Build.VERSION.SDK_INT >= Build.VERSION_CODES.GINGERBREAD;
