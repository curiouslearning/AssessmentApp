 ...
 */
public enum eType {Tap, Trashed, Selected, Drag, Init, NewQuestion, EndGame, TimeHalfway, CategoryChange, QueueAudio, StartAudio, AudioFinish, TimedOut, FingerDown, FingerUp, Grab, Ready, NewGame, Payoff, Transition}; //basic enum that contains all signalable events
